...
<!--                <img src="http://woocomp.ru/assets/uploads/2016/10/wi-fi.png">-->
            ...
            <div class="actions md-layout md-alignment-center-space-between">
                ...
                <md-button type="submitlet user = JSON.parse(localStorage.getItem('user'))" class="md-raised md-primary" @click="auth">Log in</md-button>
            </div>
    ...
    export default {
        ...
        methods: {
            auth() {
                ...
                // this.$http.get(this.$hostname +'/api/security/users/',  { headers: {
                //   Authorization: "Kfmn eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImV4cCI6MTU3MTU5MzU3MCwiaWF0IjoxNTcxNTkzMjcwfQ.c7YYuaNNUjt1v3VjvDHhT7J3LIvFx0a9Dyad_e6PlMh6Ii8O3OkreqLRW4dje1N9Po20gx7U4epjhknYfFT5cQ"
                // } })


                this.$http.post(this.$hostname + '/login', {
